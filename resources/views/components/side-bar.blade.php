    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="https://patagoniaenruta.cl" class="flex ms-2 md:me-24">
                    <img src="/logo_patagoniaenruta.jpg" class="h-8 me-3" />
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Patagonia
                        en Ruta</span>
                </a>
            </div>
...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <x-button-nav dropdown="dropdown-destinations" name="Destinos" />
            <ul id="dropdown-destinations" class="hidden py-2 space-y-2">
                <li>
            ...
            <x-button-nav dropdown='dropdown-tours' name="Tours" />
            ...
            <x-button-nav dropdown='dropdown-reservas' name="Reservas" />
            <ul id="dropdown-reservas" class="hidden py-2 space-y-2">
                <li>
